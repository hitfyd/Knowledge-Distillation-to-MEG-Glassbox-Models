...
pretrain_student_model_fakd_path = "../checkpoint/Models_Train/CamCAN_SDT_ShapleyFAKD-CE"
pretrain_student_model_fakd_ce_path = "../checkpoint/Models_Train/CamCAN_SDT_ShapleyFAKD"
