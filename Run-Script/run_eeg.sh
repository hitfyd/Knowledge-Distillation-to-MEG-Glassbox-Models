...
python train.py --cfg ../configs/BCIIV2a/KD/eegnetv4_sdt.yaml  SOLVER.BATCH_SIZE 64  KD.TEMPERATURE 4

python train.py --cfg ../configs/BCIIV2a/GKD/eegnetv4_sdt.yaml  SOLVER.BATCH_SIZE 64 GKD.TEMPERATURE 4

python train.py --cfg ../configs/BCIIV2a/MSEKD/eegnetv4_sdt.yaml  SOLVER.BATCH_SIZE 64

python train.py --cfg ../configs/BCIIV2a/DKD/eegnetv4_sdt.yaml  SOLVER.BATCH_SIZE 64 DKD.T 4

python train.py --cfg ../configs/BCIIV2a/ShapleyFAKD/eegnetv4_sdt.yaml  SOLVER.BATCH_SIZE 64
