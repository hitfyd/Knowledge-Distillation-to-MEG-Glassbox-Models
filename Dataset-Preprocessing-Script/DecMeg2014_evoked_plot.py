...
if __name__ == '__main__':
    ...
    # scramble_times = np.arange(0.16, 0.24, 0.004)
    # face_times = np.arange(0.16, 0.24, 0.004)
    scramble_times = 0.184
    face_times = 0.224
    cmap = 'Oranges'

    scramble_evoked_peak_feature = scramble_evoked.data[:, 171]     # 对应0.184s处的通道信号值
    face_evoked_peak_feature = face_evoked.data[:, 181]     # 对应0.224s处的通道信号值
