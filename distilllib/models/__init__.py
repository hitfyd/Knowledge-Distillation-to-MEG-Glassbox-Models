...
model_dict = {
    ...
    "DecMeg2014_lfcnn": (lfcnn, model_checkpoint_prefix + "DecMeg2014_LFCNN_20220616192753_checkpoint.pt"),
    "DecMeg2014_varcnn": (varcnn, model_checkpoint_prefix + "DecMeg2014_VARCNN_20220616192753_checkpoint.pt"),
